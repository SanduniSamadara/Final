...
import lk.ijse.FinalProject.dao.custom.EmployeeDaoImpl;
    ...
    private void loadAllEmployee() throws SQLException, ClassNotFoundException {
        ...
        try {
            ...
            for (EmployeeDTO dto : allEmployee) {
                ...
                tblEmployee.getItems().add(new EmployeeTM(dto.getId(), dto.getAddress(), dto.getName(), dto.getContact(), dto.getPosition(), dto.getPosition(), btn));
