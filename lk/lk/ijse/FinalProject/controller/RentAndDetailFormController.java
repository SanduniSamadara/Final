...
import lk.ijse.FinalProject.dao.custom.RentDaoImpl;
...
public class RentAndDetailFormController {
    ...
    private void loadRentData() throws SQLException, ClassNotFoundException {
        ...
        try {
            ArrayList<RentDTO> allRent = rentDao.getRent();
            for (RentDTO dto : allRent) {
                Button btn = new Button("Delete");
                tblrent.getItems().add(new RentTM(dto.getId(), dto.getReserveDate(), dto.getStartDate(), dto.getCustomerId(), btn));
