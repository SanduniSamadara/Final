...
import lk.ijse.FinalProject.dao.custom.RepairDaoImpl;
...
public class RepairFormController {
    ...
    private void loadAllRepairData() {
        ...
        try {
            ArrayList<RepairDTO> allRepair = repairDao.getAllRepairs();
            for (RepairDTO dto : allRepair) {
                Button btn = new Button("Delete");
                tblrepair.getItems().add(new RepairTm(dto.getRepairId(), dto.getRepairPrize(), dto.getVehicleId(), btn));
    ...
    public boolean updateOnAction(CustomerDTO id) throws SQLException, ClassNotFoundException {
