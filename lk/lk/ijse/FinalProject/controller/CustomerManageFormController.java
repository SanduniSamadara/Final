...
import lk.ijse.FinalProject.dao.custom.CustomerDaoImpl;
...
public class CustomerManageFormController {
    ...
    private void loadAllCustomer() { //Load All Customer Table
        ...
        try {
            ...
            for (CustomerDTO dto : allCustomer) {
                ...
                customerTable.getItems().add(new CustomerTM(dto.getId(), dto.getName(), dto.getNic(), dto.getAddress(), dto.getContact(), btn));
    ...
    public boolean updateOnAction(String id) throws SQLException, ClassNotFoundException {
        CustomerDaoImpl customerDao = new CustomerDaoImpl();
        return customerDao.ifExistCustomer(id);
    ...
    public boolean deleteOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        CustomerDaoImpl customerDao = new CustomerDaoImpl();
